		...
		<nav class="cd-side-nav">
			...
			<ul>
				...
				<li class="jobs active">
					<a href="job.php?user=<?php echo $_SESSION['login_user'];?>">Loan</a>
				</li>
		...
		<div class="content-wrapper">
			<br><br>
	            <div class="pro-education student">
    	        	<h1 class="heading">Applied Loans<button id="add-edu" class="add-button remove">+ Apply For Loan</button></h1>
