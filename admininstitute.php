...
<body>
  <header class="cd-main-header">
    <a href="admin.php" class="cd-logo"><img src="images/sugarlogo.jpg" alt="Logo"></a>
  ...
  <main class="cd-main-content">
    <nav class="cd-side-nav">
      <ul>
        ...
        <li class="profile">
          <a href="admin.php">Farmers/ Consumers</a>
        </li>

        <li class="messages active">
          <a href="admininstitute.php">Factories</span></a>
        </li>

        <li class="has-children documents">
          <a href="admincompany.php">Banks $ Saccos</a>
        </li>
      </ul>
        ...
        <div class="info-box">
          ...
          <div class="pro-title">
                  <center><img class="profile-image" src="images/avatar-01.jpg">
                   <p id="pro-name" style="font-weight: bold;">List of Registered Factories</p></center>
                </div>
  ...
  <table>
    ...
    <?php 
      $query=mysqli_query($connection,"SELECT * FROM user WHERE user_type='institute'");
