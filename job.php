		...
		<nav class="cd-side-nav">
			...
			<ul>
				...
				<li class="jobs active">
					<a href="job.php?user=<?php echo $_SESSION['login_user'];?>">Loan Packages</a>
				</li>
		...
		<div class="content-wrapper">
			<br><br>
	            <div class="pro-education student">
    	        	<h1 class="heading">Available Loan Packages<button id="add-edu" class="add-button remove">+ Apply For Loan</button></h1>
    	        	...
    	        	<center>
	            	    <form id="form-edu" hidden="" class="remove" action="apply-job.php">
	            	   		<select id="institute" name="institute" onchange="fill_degree()">
	            	   			<option value="select-inst">Select Bank/Sacco</option>
	            	   			<?php
	            	   		...
	            	   		<select id="degree" name="degree" required="">
	            	   			<option value="select-deg">Select Loan</option>
	            	   			<script>
