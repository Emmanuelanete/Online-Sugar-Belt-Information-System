...
<body onload="check()">
	...
	<header class="cd-main-header">
		<a href="profile.php?user=<?php echo $_SESSION['login_user'];?>" class="cd-logo"><img src="images/sugarlogo.jpg" alt="Logo"></a>
	...
	<main class="cd-main-content">
		<nav class="cd-side-nav">
			<ul>
				...
				<li class="profile active">
					<a href="profile.php?user=<?php echo $_SESSION['login_user'];?>">Update Harvest Profile</a>
				</li>
			...
			<ul>
				...
				<li class="jobs">
					<a href="job.php?user=<?php echo $_SESSION['login_user'];?>">Bank $ Sacco Loans</a>
				</li>
		...
		<div class="content-wrapper">
			<div class="profile-container">
				<div class="info-box">
					<img id="pro-timeline" src="images/background.jpg"></img>
					<div class="pro-title">
	            ...
	            <div class="pro-education student">
    	        	<h1 class="heading">Farm $ Harvest Details<button id="add-edu" class="add-button remove">+ Add New</button></h1>
    	        	...
    	        	<center>
	            	    <form id="form-edu" hidden="" class="remove" action="update-profile.php">
	            	   		<select id="institute" name="institute" onchange="fill_degree()">
	            	   			<option value="select-inst">Select Nearest Sugar Factory of preference.</option>
	            	   			<?php
	            	   		...
	            	   		<select id="degree" name="degree" required="">
	            	   			<option value="select-deg">Select the Farm Zone</option>
	            	   			<script>
	            	    	...
	            	    	<select id="from_year" name="from_year">
	            	    		<option value="year">When did you join the Farming Industry</option>
  								<script>
  									var myDate = new Date();
							...
							<select id="to_year" name="to_year">
	            	    		<option value="year">Expected Year of Next Harvest</option>
  								<script>
  									var myDate = new Date();
  									var year = myDate.getFullYear();
  									for(var i = year+10; i > 2020 ; i--){
	  									document.write('<option value="'+i+'">'+i+'</option>');
  									}
	            ...
	            <div class="pro-skill student">
	            	<h1 class="heading"> Indicate Farm Size(In Hactares)<button id="add-ski" class="add-button remove">+ Add New</button></h1>
	            	<div class="pro-skill-body pro-body">	
		                <center><form id="form-ski" hidden="" class="remove" action="update-profile.php">
		                	<input type="text" id="skill" name="skill" required="" placeholder="Indicate Farm size (ex: 5.5)" ><br><br/>
    	        ...
    	        <div class="pro-interest student">
    	        	<h1 class="heading">Preffered Harvest Mode.<button id="add-int" class="add-button remove">+ Add Any Other Note</button></h1>
					<center>
					
					<option value="preference">Green Cane.</option>
					<option value="preference">Burnt Cane.</option>
					<option value="preference">Mixed (Green and Burnt) </option>
					<option value="preference">No preference (Factory to Decide).</option>
					
					</center>
    	        	<div class="pro-interest-body pro-body">
    		            <center><form id="form-int" hidden="" class="remove" action="update-profile.php">
    	    	        	<input type="text" id="interest" name="interest" required="" placeholder="Select from List Above" ><br><br/>
