...
<body>
        ...
        <div class="info-box">
          ...
          <div class="pro-title">
                  <center><img class="profile-image" src="images/avatar-01.jpg">
                   <p id="pro-name" style="font-weight: bold;">List of Registered Banks and Saccos</p></center>
                </div>
  ...
  <table>
    ...
    <?php 
      $query=mysqli_query($connection,"SELECT * FROM user WHERE user_type='company'");
