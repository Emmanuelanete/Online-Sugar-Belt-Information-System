...
<body>
	<header class="cd-main-header">
		<a href="company.php?user=<?php echo $_SESSION['login_user'];?>" class="cd-logo"><img src="images/sugarlogo.jpg" alt="Logo"></a>
		...
		<div class="content-wrapper">
			<div class="profile-container">
	            ...
	            <div class="pro-education student">
    	        	<h1 class="heading">Update Loan Packages<button id="add-edu" class="add-button remove">+ Add New</button></h1>
    	        	...
    	        	<center>
	            	    <form id="form-edu" hidden="" class="remove" action="update-company.php">
	            	   		...
	            	   		<input type="text" name="Loan Purpose" placeholder="Enter General Loan Purpose"> <br>
	            	   		<input type="text" name="location" placeholder="Enter Loan Amount/Range"> <br>
	            	   		<input type="text" name="description" placeholder="Enter Description"> <br>
	            	   		<input type="number" name="salary" placeholder="Enter Interest Rate(%Per Annum)"> <br>
	            	   		<select id="jobtype" name="jobtype">
	            	   			<option value="job-type">Select Specific Loan Purpose.</option>
	            	   			<option value="Full Time">Farmer: To expand farming scale.</option>
	            	   			<option value="Part Time">Farmer: To start farming project.</option>
								<option value="Consumer">Retail Consumer: Start Business.</option>
								<option value="Consumer">Retail Consumer: Expand Business.</option>
								<option value="Consumer">Wholesale Consumer: Boost Stock.</option>
	            	   		</select>
	            	   		<br/><br/>
		                	&nbsp;
						...
						<?php
												...
												if ($deg_table)
												{
													...
													echo "<p style='padding-bottom: 10px;'><span style='font-weight:bold;'>Loan Purpose : </span>".$deg_column['job_type']."</p>";
													echo "<p style='padding-bottom: 10px;'><span style='font-weight:bold;'>Loan Amount/Range : </span>".$deg_column['location']."</p>";
													echo "<p style='padding-bottom: 10px;'> <span style='font-weight:bold;'>Loan Description : </span>".$deg_column['description']."</p>";
													echo "<p style='padding-bottom: 10px;'> <span style='font-weight:bold;'>Interest Rate : </span>".$deg_column['salary']." Per Annum</p>";
												}
						?>
