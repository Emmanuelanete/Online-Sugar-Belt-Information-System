...
<body id="home">
		...
		<section class="signup-section">
			<div class="login">
				<form id="form_signup" name="form_signup" action="signup.php" method="post">
					<ul class="ul-list">
						<li><input type="radio" id="student" name="check-type" onchange="check_type()" value="student" checked> Farmer/Consumer&emsp;<input type="radio" id="inst" name="check-type" value="institute" onchange="check_type()"> Factory&emsp; <br><input type="radio" id="comp" name="check-type" value="company" onchange="check_type()"> Bank/Sacco</li>
					...
					<script type="text/javascript">
						function check_type(){
							if ($("#student").is(":checked")){
								$("input#reg_name").prop("placeholder","Name");
								$("input#reg_name span i").text("account_box");
							}

							else if ($("#inst").is(":checked")){
								$("input#reg_name").prop("placeholder","Factory Name");
								$("input#reg_name span i").text("account_balance");	
							}
							else{
								$("input#reg_name").prop("placeholder","Bank/Sacco Name");
	...
	<header>
		...
		<div class="horizontal-page-links" id="nav">
			...
			<ul>	
				<div class="sliding-out links"><li><a href="#home">Online Sugar Belt Information System</a></li></div>
				<div class="sliding-out links"><li><a href="#about">About </a></li></div>
				<div class="sliding-out links"><li><a href="#contact">Contact </a></li></div>
				<div class="sliding-out links"><li><a href="adminlogin.php" style="color: red;">Admin</a></li></div>
			</ul>
	...
	<div class="welcome wrap-width">
		...
		<div class="welcome-text">
			<br>
			<p id="text-heading">Online Sugar Belt Information System</p><br>
			<p id="text-context">The OSBIS is a platform to bring together all the sugarcane stakeholders in a single pool of communication, service and product delivery upon demand.<br> OSBIS brings together, <br> Farmers,Factory Admins, Consumers, Banks and Saccos.  </p>
	...
	<div class="link-container clearfix">
		...
		<a id="register">Sign Up Now</a>
			<p id="join">Join the OSBIS - Be a part of the growing community.</p>
		</div> 
	</div>	 <!-- link-container -->

	
	<div class="about-container clearfix wrap-width" id="about">
		<p id="title">Get To Know About OSBIS.</p><hr class="style-1" style="width: 600px; align-self: center;"><br/>
		...
		<p>OSBIS is a platform to bring together all the sugarcane stakeholders in a single pool of communication, service and product delivery upon demand.   </p>
		</div>	<!-- col_one_third -->
		<div class="col_one_third col_2nd">
		<h1>OSBIS <span>DEALS WITH</span>.</h1>
		<div class="bottom-border"></div>	<!-- border-bottom -->
		
		<p>OSBIS Deals with sugarcane stakeholders. The Farmers, The Processing Factories, Consumers, Banks $ Saccos.  </p>
		</div>	<!-- col_one_third -->
		<div class="col_one_third col_3rd">
		<h1>OUR WORKING <span>ZONES</span>.</h1>
		<div class="bottom-border"></div> <!-- border-bottm -->	
		<p> OSBIS focuses on all sugarcane farming zones in Western Province and Nyanza icluding all sugarcane milling factories in the stated zones.</p>
		...
		<div id="form-main">
    		...
    		<div class="contact-div contact-detail">
    			...
    			<div class="detail-container" id="phone-no">
    				...
    				<p class="contact-context" id="phone-text"> (+254) 792627304 <br><br>
    															(+254) 70000000</p>
    			</div>
    			<div class="detail-container" id="email-id">
    				<i class="material-icons second">email</i>
	    			<p class="contact-context" id="mail-text">manuanete5@gmail.com <br><br>
	    													  eanete5@gmail.com </p>
	    		</div>
	...
	<footer>
		...
		<div id="copyrights">
				<span class="siteName">Online Sugar Belt Information System &copy 2021. All rights reserved.</span>
            </div><!--copyrights-->
	</footer>
