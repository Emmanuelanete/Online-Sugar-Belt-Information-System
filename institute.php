...
<body>
	<header class="cd-main-header">
		<a href="institute.php?user=<?php echo $_SESSION['login_user'];?>" class="cd-logo"><img src="images/sugarlogo.jpg" alt="Logo"></a>
		...
		<div class="content-wrapper">
			<div class="profile-container">
	            ...
	            <div class="pro-education student">
    	        	<h1 class="heading">Available Farm Zones<button id="add-edu" class="add-button remove">+ Add New</button></h1>
    	        	<div class="pro-education-body pro-body">
    	        	<center>
	            	    <form id="form-edu" hidden="" class="remove" action="update-degree.php">
	            	    	<input type="text" name="institute" value="<?php echo $_SESSION['login_user'];?>" hidden>
	            	   		...
	            	   		<br/>
	            	   		<input type="text" name="name-of-degree" placeholder="Enter Name of available Program Zones.">
	            	   		<br/><br/>
	               		...
	               		<?php
							$query = "SELECT * FROM `degree` join `user` on (institute_id = id) where institute_id = ".$_GET['user'];
							$table = mysqli_query($connection,$query);
							if($table){
								$rows=mysqli_num_rows($table);
								if($rows > 0){
